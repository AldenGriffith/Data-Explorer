            ...
            sidebarPanel(
                ...
                conditionalPanel(
                    ...
                    tabsetPanel(id = "plot-tabs",
                                tabPanel("Variables", 
                                         ...
                                         shinyjs::hidden(div(id = "SubSel_dy", selectInput("SubSel_dy", "Subsetting groups (click below):", choices = choices$SubSel_dy,
                                                                                           selected = sels$SubSel_dy, multiple=TRUE))),
                                         
                                         checkboxInput("Show.Vars.Options", "Show Variable Options", value = FALSE),
                ...
                tabPanel("Models",
                         ...
                         shinyjs::hidden(div(id = "div.Models",
                                             ...
                                             #                        choices = NULL, selected = NULL),  ##WRONG SELECTION
                                             #     
